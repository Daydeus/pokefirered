...
{   // { width, height, offset }
    ...
    [MENU_INFO_ICON_TYPE]      = { 40, 12, 0xAA },
    [MENU_INFO_ICON_POWER]     = { 40, 12, 0xC4 },
    [MENU_INFO_ICON_ACCURACY]  = { 40, 12, 0xCA },
    [MENU_INFO_ICON_PP]        = { 40, 12, 0xE4 },
    [MENU_INFO_ICON_EFFECT]    = { 40, 12, 0xEC },
    [CATEGORY_PHYSICAL]        = { 32, 12, 0x04 },
    [CATEGORY_SPECIAL]         = { 32, 12, 0x08 },
    [CATEGORY_STATUS]          = { 32, 12, 0x0C },
};
