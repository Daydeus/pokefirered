...
const u8 gMoveDescription_Clamp[]           = _("The foe is crushed\nby the user's shell\nor pincers for two\nto five turns.");
...
const u8 gMoveDescription_FlashCannon[]     = _("Focuses a beam of\nlight energy onto\nthe foe. May also\nlower SP. DEF.");
...
const u8 gMoveDescription_HeadSmash[]       = _("The user dives at\nthe foe head first.\nIf it misses, the\nuser is badly hurt.");
...
const u8 gMoveDescription_MirrorShot[]      = _("The user looses a\nray of light off\nits shiny body. May\nlower accuracy.");
...
const u8 gMoveDestription_StoneSurge[]      = _("The user summons\nshards of stone to\nslice the foe from\nall directions.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_STONE_SURGE   - 1] = gMoveDestription_StoneSurge,
