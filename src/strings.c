...
const u8 gText_PkmnCuredOfFrostbite[] = _("{STR_VAR_1} was cured of its\nfrostbite.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_GeneralOption[] = _("GENERAL OPTIONS");
const u8 gText_BattleOption[] = _("BATTLE OPTIONS");
const u8 gText_TextSpeed[] = _("TEXT SPEED");
const u8 gText_BattleScene[] = _("BATTLE SCENE");
const u8 gText_BattleStyle[] = _("BATTLE STYLE");
const u8 gText_MovementMode[] = _("MOVEMENT");
...
const u8 gText_MovementWalk[] = _("WALK");
const u8 gText_MovementRun[] = _("RUN");
const u8 gText_BattleItemBanFoe[] = _("FOE");
const u8 gText_BattleItemBanPlayer[] = _("PLAYER");
const u8 gText_BattleItemBanBoth[] = _("BOTH");
const u8 gText_PickSwitchCancel[] = _("{SELECT_BUTTON}PAGE {DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}{B_BUTTON}CANCEL");
