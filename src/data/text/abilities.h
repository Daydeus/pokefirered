...
static const u8 sOvergrowDescription[] = _("Ups GRASS moves as HP falls.");
static const u8 sBlazeDescription[] = _("Ups FIRE moves as HP falls.");
static const u8 sTorrentDescription[] = _("Ups WATER moves as HP falls.");
static const u8 sSwarmDescription[] = _("Ups BUG moves as HP falls.");
