...
extern const u8 BattleScript_IngrainFinalHeal[];
extern const u8 BattleScript_RetractedItsRoots[];
extern const u8 BattleScript_FocusEnergyTurnHeal[];
extern const u8 BattleScript_FocusEnergyFinalHeal[];
extern const u8 BattleScript_FocusEnergyRanOut[];
...
extern const u8 BattleScript_BattleTowerTrainerBattleWon[];
extern const u8 BattleScript_EnduredWithAbility[];
